...
class Ui_AmazonFramerateApp(object):
    def setupUi(self, AmazonFramerateApp):
        ...
        self.check_25 = QtGui.QRadioButton(self.groupBox)
        self.check_25.setObjectName(_fromUtf8("check_25"))
        self.horizontalLayout_4.addWidget(self.check_25)
    ...
    def retranslateUi(self, AmazonFramerateApp):
        ...
        self.check_25.setText(_translate("AmazonFramerateApp", "25 Non-Drop", None))
